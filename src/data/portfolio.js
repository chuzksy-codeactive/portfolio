  ...
  data: [
    {
      id: 9,
      name: 'Survely',
      tech: ['React', 'Redux', 'NodeJS', 'ExpressJS', 'MongoDB', 'Mongoose', 'Stripe', 'Passportjs', 'OAuth2', 'SendGrid'],
      ...
      projectDetails: 'This is a full-stack project built with Node, Express, React, Redux, Passport.js, Sendgrid, OAuth2, Stripe. It is a simple project that sends out surveys to users via emails and accepts payments to purchase credits',
      resources: {
